...
<div class="flex flex-col items-center justify-center w-full">
	<section class="flex flex-col w-full relative text-white font-sans">
		<div class="absolute inset-0 -z-0 overflow-hidden pointer-events-none bg-neutral-50">
			<img
				src="/canvas.webp"
				class="block object-cover w-full h-full brightness-70"
				alt="solutions cover image"
			/>
		</div>
		<div
			class="flex flex-col w-full max-w-7xl mx-auto min-h-screen justify-end pb-8 py-5 px-6 md:px-10 relative z-10"
		>
			<h1 class="text-5xl font-semibold mb-2 w-full">โซลูชั่นพร้อมแก้ปัญหาให้ธุรกิจของคุณ</h1>
			<p class="text-xl mb-4">ระบบแปลเอกสารครบในที่เดียว</p>
			<a href="https://www.dooform.com" target="_blank" class="button-white">ทดลองใช้งาน</a>
		</div>
	</section>
</div>
